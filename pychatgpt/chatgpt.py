...
class ChatGPT:
    def __init__(self, apikey: str, model: str = "gpt-3.5-turbo") -> None:
        ...
        apikey: str
            ...
            Visit https://platform.openai.com/account/api-keys to retrieve the API key you'll use in your requests.
    ...
    async def complete(
            ...
            max_tokens: int = 4096, presence_penalty: float = 0,
        ...
        async with ClientSession() as session:
            response = await session.post(
                ...
                json={
                    ...
                    "max_tokens": int(max_tokens), "user": str(user),
